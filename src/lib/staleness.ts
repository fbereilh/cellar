...
import { hasPythonDataflow, type NotebookLanguage } from '$lib/cellLanguage';
...
export function computeStaleness(
	...
	// is why a Mojo notebook needs no chip-level special case anywhere.
	//
	...
	const codeCells = cells.filter((c) => hasPythonDataflow(c, nbLang));

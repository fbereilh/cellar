...
function registerTools(server) {
	...
	server.registerTool('get_errors', { description: 'List cells whose latest output is an error (ename/evalue/traceback). ran_this_session:false means the error was loaded from the .ipynb and was raised by a PREVIOUS session, not the live kernel.', inputSchema: {} }, async () => text(svc.getErrors()));

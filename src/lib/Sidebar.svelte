...
{#snippet databricksSection()}
	...
	{#if databricksMounted}
		<div class:hidden={!open.databricks}>
			<Databricks notebookPath={activeNotebookPath} kernelSessionId={kernelInfo?.session_id ?? null} {onInsertAndRun} onSessionChange={onDatabricksSessionChange} {onRestartKernel} />
		</div>
	{/if}
{/snippet}
